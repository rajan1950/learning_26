...
import { OmdbSearchMovieDetail } from './components/API/OmdbSearchMovieDetail.jsx'
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/apidem4" element={<ApiDemo4></ApiDemo4>}></Route>
        <Route path="/apidem5" element={<ApiDemo5></ApiDemo5>}></Route>
        <Route path="/omdbsearch" element={<OmdbSearch></OmdbSearch>}></Route>
        <Route path="/omdb/:id" element={<OmdbSearchMovieDetail></OmdbSearchMovieDetail>}></Route>
